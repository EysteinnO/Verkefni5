...
class SongsController
{
    ...
    public function addSong()
    {
        ...
        if (isset($_POST["submit_add_song"])) {
            ...
            $Song->addSong($_POST["Author"], $_POST["Book"],  $_POST["Publisher"], $_POST["Year"]);
        }
     ...
     */
    public function deleteSong($BookID)
    {
     ...
     */
    public function editSong($BookID)
    {
    ...
    public function updateSong()
    {
        ...
        if (isset($_POST["submit_update_song"])) {
            ...
            $book->updateSong($_POST["Author"], $_POST["Book"],  $_POST["Publisher"], $_POST["Year"], $_POST['BookID']);
        }
